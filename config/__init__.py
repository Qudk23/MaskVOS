...
class Parameters():
    def __init__(self):
        ...
        parser.add_argument('--trainset', type=str, default='MaskVOS_swin_tiny_finetune')
        # parser.add_argument('--trainset', type=str, default='MaskVOS_swin_tiny_pretrained')
        parser.add_argument('--save_path', type=str, default='./exp_logs/MaskVOS_swin_tiny_finetune/')
        # parser.add_argument('--save_path', type=str, default='./exp_logs/MaskVOS_swin_tiny_pretrained/')
        parser.add_argument('--restore_from', type=str, default='./exp_logs/MaskVOS_swin_tiny_pretrained/best.pth')
        ...
        parser.add_argument('--train_root', type=str, default='./dataset/TrainSet/DAVIS_FBMS')
        # parser.add_argument('--train_root', type=str, default='./dataset/TrainSet/YoutubeVOS')
        parser.add_argument('--val_root', type=str, default='/home/qdk/code/MaskVOS-master/dataset/TestSet')
        ...
        parser.add_argument('--infer_save', type=str, default='./exp_logs/tmp_results')
